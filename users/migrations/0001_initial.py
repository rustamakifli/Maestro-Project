# Generated by Django 4.2.5 on 2023-09-08 12:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to=core.utils.tools.get_users_image, verbose_name='user image')),
                ('email', models.EmailField(db_index=True, max_length=255, unique=True, verbose_name='email address')),
                ('gender', models.CharField(choices=[('male', 'Kişi'), ('female', 'Qadın')], null=True, verbose_name='cinsi')),
                ...
                ('is_test', models.BooleanField(default=False, help_text='Designates whether this user was created by developers or not.', verbose_name='test user')),
